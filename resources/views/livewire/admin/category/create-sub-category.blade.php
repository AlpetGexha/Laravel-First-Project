<x-modal>
    ...
    <div class="d-flex bd-highlight">
        ...
        <div class="col-md-2">
            <select wire:model="SubCategoryNumberSelect" class="form-control bd-highlight ">
    ...
    <div class="mb-3">
        ...
        <x-jet-input class="{{ $errors->has('subcategory') ? 'is-invalid' : '' }}" type="text" name="subcategory"
            :value="old('subcategory')" autofocus autocomplete="subcategory" wire:model.def="subcategory" />
